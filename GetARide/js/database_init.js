...
window.onload = function() {
    ...
    alasql("CREATE TABLE IF NOT EXISTS rides (ride_id INT NOT NULL AUTO_INCREMENT, passenger_id INT, driver_id INT, vehicle_id INT, fee DOUBLE, tax DOUBLE, origin VARCHAR(50), destination VARCHAR(50), start_time DATETIME, end_time DATETIME, user_rating INT, payment_card_id INT, status BOOLEAN, PRIMARY KEY (ride_id))");
