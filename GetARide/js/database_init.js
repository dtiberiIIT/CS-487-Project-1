...
function populate(tog){
    if(tog){
        ...
        newRide(1,2,3,15.00, 0.75, "empire state building", "chrysler building", 1,1,5,0);
        newRide(1,2,3,12.00, 0.75, "8 rue alcide delapierre", "15 rue theodore maillart", 1,1,4,0);
